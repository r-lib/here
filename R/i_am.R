...
#'
#'   If not `NULL`, a unique string that is matched against the first 100 lines of the file.
#'   Use [uuid::UUIDgenerate()] to create a unique string that can be used as a `uuid` argument.
#'
