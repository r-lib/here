...
#> - Current working directory: /tmp/RtmpZw8m2g
...
uuid::UUIDgenerate()
#> [1] "0107e6d7-2112-480f-9206-a07d07a7c979"
```
...
#> /tmp/RtmpZw8m2g/file25af659fe424
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpZw8m2g/file25af659fe424
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
