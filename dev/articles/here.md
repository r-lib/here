...
#> - Current working directory: /tmp/Rtmprwl2ex
...
uuid::UUIDgenerate()
#> [1] "bb42332d-3244-4aa3-bd11-a6aba894c938"
```
...
#> /tmp/Rtmprwl2ex/file277a4e07f8df
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmprwl2ex/file277a4e07f8df
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
