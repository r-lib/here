...
#> - Current working directory: /tmp/Rtmp3G3G6J
...
uuid::UUIDgenerate()
#> [1] "0be62208-d12d-4831-9068-769f3d24c3bc"
```
...
#> /tmp/Rtmp3G3G6J/file25b044139c11
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmp3G3G6J/file25b044139c11
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
