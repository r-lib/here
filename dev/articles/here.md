...
#> - Current working directory: /tmp/RtmpEu7X3B
...
``` r
uuid::UUIDgenerate()
#> [1] "0c32b6e9-e3d6-44f2-bd8d-eb32219a878f"
```
...
#> /tmp/RtmpEu7X3B/file30bc5bd3aee8
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpEu7X3B/file30bc5bd3aee8
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
