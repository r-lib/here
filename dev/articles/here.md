...
#> - Current working directory: /tmp/Rtmp1bo8Zu
...
uuid::UUIDgenerate()
#> [1] "d815d55f-6510-4e7f-ba3a-39e6558bb860"
```
...
#> /tmp/Rtmp1bo8Zu/file25376e89d9a1
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmp1bo8Zu/file25376e89d9a1
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
