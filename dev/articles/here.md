...
#> - Current working directory: /tmp/Rtmpt5c3cG
...
uuid::UUIDgenerate()
#> [1] "ed8b06c9-04f1-4a17-9cae-39cc96e2677e"
```
...
#> /tmp/Rtmpt5c3cG/file275e3933a04a
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmpt5c3cG/file275e3933a04a
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
