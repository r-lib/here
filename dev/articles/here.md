...
#> - Current working directory: /tmp/RtmpH5cIKp
...
uuid::UUIDgenerate()
#> [1] "745719cc-312c-49b0-b4d4-2155edd51de4"
```
...
#> /tmp/RtmpH5cIKp/file28ee4229b0bd
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpH5cIKp/file28ee4229b0bd
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
