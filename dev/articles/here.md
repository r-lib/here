...
#> - Current working directory: /tmp/Rtmp1P8ADH
...
uuid::UUIDgenerate()
#> [1] "45b2bc64-971c-43e3-ba80-5799d37b840f"
```
...
#> /tmp/Rtmp1P8ADH/file267c1d40853d
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmp1P8ADH/file267c1d40853d
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
