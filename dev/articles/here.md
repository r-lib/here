...
#> - Current working directory: /tmp/RtmpBf0aIm
...
uuid::UUIDgenerate()
#> [1] "92474f41-d736-423b-aa97-a3c433c9e331"
```
...
#> /tmp/RtmpBf0aIm/file273b56caa1ae
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpBf0aIm/file273b56caa1ae
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
