...
#> - Current working directory: /tmp/RtmpcmImoq
...
``` r
uuid::UUIDgenerate()
#> [1] "6d43ab53-f728-404e-89da-f1e0c4645414"
```
...
#> /tmp/RtmpcmImoq/file2ff032ecfd69
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpcmImoq/file2ff032ecfd69
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
