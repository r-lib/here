...
#> - Current working directory: /tmp/Rtmp9pDhVT
...
``` r
uuid::UUIDgenerate()
#> [1] "a8aae0fa-452a-459e-99c3-a567cd6bb645"
```
...
#> /tmp/Rtmp9pDhVT/file2fca6f5c2092
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmp9pDhVT/file2fca6f5c2092
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
