...
#> - Current working directory: /tmp/RtmpNEI1qR
...
uuid::UUIDgenerate()
#> [1] "37a69a21-708f-448e-b8ea-62cd19a5d138"
```
...
#> /tmp/RtmpNEI1qR/file267c2910a37b
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpNEI1qR/file267c2910a37b
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
