...
#> - Current working directory: /tmp/RtmpWL4kgY
...
uuid::UUIDgenerate()
#> [1] "5421b562-a6b7-48fb-a37d-394b1f536ebc"
```
...
#> /tmp/RtmpWL4kgY/file26d92ccd13da
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpWL4kgY/file26d92ccd13da
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
