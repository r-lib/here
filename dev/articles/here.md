...
#> - Current working directory: /tmp/RtmprfUFjL
...
uuid::UUIDgenerate()
#> [1] "158ea674-0cae-4d08-93d6-58842ac3c068"
```
...
#> /tmp/RtmprfUFjL/file267538347ce1
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmprfUFjL/file267538347ce1
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
