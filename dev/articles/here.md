...
#> - Current working directory: /tmp/RtmpL0BJKE
...
uuid::UUIDgenerate()
#> [1] "20b54796-1961-4e90-b555-67ce17c974e9"
```
...
#> /tmp/RtmpL0BJKE/file26c24fe6e66e
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpL0BJKE/file26c24fe6e66e
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
