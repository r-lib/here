...
#> - Current working directory: /tmp/RtmppF47kW
...
uuid::UUIDgenerate()
#> [1] "13d42d91-e72a-45b5-b8aa-d45c849df6eb"
```
...
#> /tmp/RtmppF47kW/file27692ce400c9
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmppF47kW/file27692ce400c9
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
