...
#> - Current working directory: /tmp/Rtmpdk8Atg
...
uuid::UUIDgenerate()
#> [1] "e1f9029a-517e-4618-9d77-cafd0b6ff2c7"
```
...
#> /tmp/Rtmpdk8Atg/file27434f11823d
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmpdk8Atg/file27434f11823d
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
