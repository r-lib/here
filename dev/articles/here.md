...
#> - Current working directory: /tmp/Rtmpvdo0ha
...
uuid::UUIDgenerate()
#> [1] "1e9df4a3-9aad-4adc-a10d-98891b50456c"
```
...
#> /tmp/Rtmpvdo0ha/file270a57c6f912
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmpvdo0ha/file270a57c6f912
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
